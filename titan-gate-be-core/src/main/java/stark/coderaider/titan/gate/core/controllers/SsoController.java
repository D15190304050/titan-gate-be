...
public class SsoController
{
    ...
    public ServiceResponse<UserInfo> validateToken(HttpServletRequest request, @RequestBody ValidateTokenRequest validateTokenRequest)
    {
        return ssoService.validateToken(request, validateTokenRequest);
    }
}
